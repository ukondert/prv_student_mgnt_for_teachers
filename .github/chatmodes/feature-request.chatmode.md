...
6. **Struktur**: Organisieren Sie das Feature Request gemäß der bereitgestellten Vorlage (`feature-request-template.md` im templates-Ordner). Fügen Sie relevante Unterüberschriften hinzu.
